    ...
    $.SmartMessageBox = function (settings, callback) {
        ...
        if (settings.input != undefined) {
            ...
            case "text":
                ...
                break;
            case "textarea":
                InputType = "<textarea class='form-control' type='" + settings.input + "' id='txt" +
                    SmartMSGboxCount + "' placeholder='" + settings.placeholder + "' rows='5'>" + settings.value + "</textarea><br/><br/>";
                break;
            case "password":
                InputType = "<input class='form-control' type='" + settings.input + "' id='txt" +
                    SmartMSGboxCount + "' placeholder='" + settings.placeholder + "'/><br/><br/>";
            ...
            if (settings.buttons[i] == "[") {
                ...
                if (settings.buttons[i] == "]") {
                    ...
                    Name = "<button id='bot" + NumBottons + "-Msg" + SmartMSGboxCount +
                        "' " + type + " class='btn btn-default btn-sm botTempo'> " + Name + "</button>";
                    Content += Name;
                } else {
