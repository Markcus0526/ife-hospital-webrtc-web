...
<html lang="en">
    ...
    <body class="page-container-bg-solid">
        <div class="page-container">
            <div class="page-content">
                <div class="portlet light">
                    ...
                    <h1>欢迎<?php p(PRODUCT_NAME); ?>安装向导</h1>
                    <p>此向导将帮您安装<?php p(PRODUCT_NAME); ?></p>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-5">
                                            <?php $mConfig->input("db_name", array("placeholder" => "例: transcard")); ?>
                                        </div>
                                    </div>
                                    <div class="form-group">
        ...
        <script src="js/bootstrap-datepicker/js/locales/bootstrap-datepicker.<?php p(_lang()); ?>.js" type="text/javascript"></script>
        ...
        <script src="js/select2/select2_locale_<?php p(_lang()); ?>.js" type="text/javascript"></script>
